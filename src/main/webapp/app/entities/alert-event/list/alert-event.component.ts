...
import { AlertEventService, EntityArrayResponseType } from '../service/alert-event.service';
...
export class AlertEventComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAlertEvent): number => this.alertEventService.getAlertEventIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.alertEvents = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAlertEvent[] | null): IAlertEvent[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.alertEventService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
