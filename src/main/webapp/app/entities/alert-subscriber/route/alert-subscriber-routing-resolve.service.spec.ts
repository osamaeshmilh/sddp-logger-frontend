...
describe('AlertSubscriber routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IAlertSubscriber returned by find', () => {
      // GIVEN
      ...
      routingResolveService.resolve(mockActivatedRouteSnapshot).subscribe(result => {
        resultAlertSubscriber = result;
      });

      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultAlertSubscriber).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAlertSubscriber).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAlertSubscriber>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
      ...
      // THEN
      expect(service.find).toBeCalledWith(123);
      expect(resultAlertSubscriber).toEqual(undefined);
