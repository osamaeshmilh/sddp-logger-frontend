...
describe('AlertSubscriber Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'alert-subscriber', component: AlertSubscriberComponent }]),
        HttpClientTestingModule,
      ],
      declarations: [AlertSubscriberComponent],
      providers: [
        {
      ...
      .overrideTemplate(AlertSubscriberComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to alertSubscriberService', () => {
      ...
      expect(service.getAlertSubscriberIdentifier).toHaveBeenCalledWith(entity);
