...
export class AlertSubscriberComponent implements OnInit {
  ...
  delete(alertSubscriber: IAlertSubscriber): void {
    const modalRef = this.modalService.open(AlertSubscriberDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.alertSubscriber = alertSubscriber;
