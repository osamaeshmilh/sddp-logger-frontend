...
describe('HttpLog Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(HttpLogComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.httpLogs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to httpLogService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHttpLogIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHttpLogIdentifier).toHaveBeenCalledWith(entity);
